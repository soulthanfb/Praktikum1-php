...
<a class="btn btn-success" href="index.php?hal=form_pelanggan" role="button">Create Pelanggan</a>
    ...
    <tbody>
        ...
        <tr style="text-align: center;">
            ...
            <td>
                ...
                <a class="btn btn-warning" href="edit_pelanggan.php?idedit=<?=$row['id']?>">Edit</a>
