        ...
        ?>
            <tr style="text-align: center;">
                ...
                <td>
                    ...
                    <a class="btn btn-primary <?= $row['is_pelanggan'] ?>" href="delete_vendor.php?iddel=<?= $row['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data Pelanggan <?= $row['nama'] ?>?')) {return false}">Delete</a>
                </td>
            </tr>
        <?php
            $nomor++;
